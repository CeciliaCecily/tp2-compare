...
public class Main2506532643
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (fill)
        {
            ...
            gameManager.addQuest(new Quest(id, "selamatkan orang yang dipenjara", "desc", "mudah", 100 * id, 1000 * id, id++));
            gameManager.addQuest(new Quest(id, "quest_" + id, "desc", "mudah", 100 * id, 1000 * id, id++));
            gameManager.addQuest(new Quest(id, "quest_" + id, "desc", "menengah", 100 * id, 1000 * id, id++));
            gameManager.addQuest(new Quest(id, "quest_" + id, "desc", "sulit", 100 * id, 1000 * id, id++));

            gameManager.addWanderer(new Wanderer(1, "Tsumugi Kotobuki", "mugichan", "cute"));
            gameManager.addWanderer(new Wanderer(2, "Yui Hirasawa", "yuichan", "guitar123"));
            gameManager.addWanderer(new Wanderer(3, "Mio Akiyama", "miochan", "cute"));
            gameManager.addWanderer(new Wanderer(4, "Ritsu Tainaka", "ricchan", "forehead"));
            gameManager.addWanderer(new Wanderer(5, "Azusa Nakano", "azunyan", "neko"));;d();
        }
    ...
    private static void helperInputQuest()
    {
        while (true)
        {
            ...
            String[] invalids = Quest.validateQuestInput(name, desc, reward, bonus, difficulty, duration);
    ...
    private static void helperInputWanderer()
    {
        while (true)
        {
            ...
            String[] invalids = Wanderer.validateWandererInput(gameManager, name, username, password);
    ...
    {
        gameManager.addWanderer(new Wanderer(6, new String(new char[] {83, 121, 97, 117, 113, 105}), new String(new char[] {115, 109, 121}), "praktikum5siang"));
        gameManager.addWanderer(new Wanderer(7, new String(new char[] {83, 101, 97, 110, 32, 70, 97, 114, 114, 101, 108}), new String(new char[] {102, 97, 114}), new String(new char[] {112, 114, 97, 107, 116, 105, 107, 117, 109, 53, 115, 105, 97, 110, 103})));
        gameManager.addWanderer(new Wanderer(8, new String(new char[] {65, 108, 119, 105, 101, 32, 65, 116, 116, 97, 114}), new String(new char[] {101, 108, 102}), new String(new char[] {112, 114, 97, 107, 116, 105, 107, 117, 109, 53, 115, 105, 97, 110, 103})));
