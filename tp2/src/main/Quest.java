public class Quest
{
    ...
    public Quest(int idNumber, String name, String description, String difficulty, int reward, int bonusExp, int daysRequired)
    {
        this.id                 = "Q" + idNumber;
        this.name               = name;
    ...
    public static String[] validateQuestInput(String name, String desc, String reward, String bonus, String diff, String duration)
    {
