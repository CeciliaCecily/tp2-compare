...
class WandererTest
{
    ...
    void setUp()
    {
        wanderer   = new Wanderer(1, "Tsumugi Kotobuki", "mugichan", "cute");
        
        easyQuest  = new Quest(1, "Easy Quest",  "jawa jawa jawa",  "mudah",    100, 50,  1);
        midQuest   = new Quest(2, "Mid Quest",   "jawa jawa jawa",  "menengah", 200, 100, 3);
        hardQuest  = new Quest(3, "Hard Quest",  "jawa jawa jawa",  "sulit",    500, 67,  5);
        takenQuest = new Quest(4, "Taken Quest", "jawa jawa jawa",  "mudah",    696, 50,  2);
